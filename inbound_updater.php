            ...
            <div class="col-md-12">
                <div class="container-box">
                    <form class="my-3 mx-3" method="post">
                        <h2 class="mb-4">Search And Update Inbound Details</h2>
                        <div class="row">
                        <div class="col-md-2">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary">Search</button>
                            ...
                            <a href="create_inb.php" class="btn btn-secondary">Create</a>
                        </div>
                    </form>
                                ...
                                if (!isset($_POST['submit'])) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo '<td>' . $row['SN'] . '</td>
                                                ...
                                                <td>
                                                    <a href="update_inb.php?SN=' . $row['SN'] . '" class="btn btn-info btn-sm">Update</a>
